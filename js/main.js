...
Modernizr.load({
  ...
  nope: '/studium/WebApps/project/_mosimann/plugins/forms/placeholder/jquery.placeholder.min.js',
  complete: function () {
...
Modernizr.load({
  ...
  yep: ['/studium/WebApps/project/_mosimann/plugins/fix/ios-fix/ios-orientationchange-fix.js', '/studium/WebApps/project/_mosimann/plugins/fix/touch-punch/jquery.ui.touch-punch.min.js']
});
...
$(document).ready(function(){ 	
	...
	var folder = null; //if you put site in folder not in main domain you need to specify it. example http://www.host.com/folder/site
